...
class PAger{
	...
	public $sql;
	function __construct($sql,$page_size=3,$page_holder='page'){
		//全局变量与局部变量的区别
		global $db;
		$this->page_start = 1;
	...
	public function nav_html($value=''){
		...
		return <<< EOT
	  <div id="pager"> 
	    <a href="$page_first_q"><font size="5" color="#ffffff">首页</front></a>
	    <a href="$page_previous_q"><font size="5" color="#ffffff">上一页</front></a>
	    <a href="$page_next_q"><font size="5" color="#ffffff">下一页</front></a>    
	    <a href="$page_last_q"><font size="5" color="#ffffff">末页</front></a>  
