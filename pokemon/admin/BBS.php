...
<?php
      ...
      ?>
          <tr>
            ...
            <td><a href="article1.php?id=<?php print $post->id; ?>"><font size="5" color="#ff5500"><?php echo $post->title; ?></font></a></td>
            <td><?php echo $post->created_at; ?></td>
            <td>
              <a href="edit.php?id=<?php echo $post->id; ?>"><font size="5" color="#ff5500">改</font></a>
              <a href="delete.php?id=<?php echo $post->id; ?>"><font size="5" color="#ff5500">删</font></a>
              <br   >
            </td>
          </tr>
          <br>
...
<a href="new.php"><font size="5" color="#ff0000">新增</font></a>
</div>
