...
<h1>评论</h1>>
<div style="border-style :solid; width: 500px;border-width: 5px;border-radius: 10px;border-color: #ff0000"> 
<form action="../comments/save.php" method="post">
    <input type="hidden" name='post_id' value='<?php echo $_GET['id']; ?>'/>
    <label for="title"><font size="5">昵称：</font>></label> <input type="text" name="title" value="" />
    <br/>
    <label for="body"><font size="5">内容：</font></label> <textarea name="body"></textarea>
    <br/>
